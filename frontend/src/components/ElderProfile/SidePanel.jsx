  ...
  return (
    <div className='flex flex-col border border-gray-300 rounded-xl h-full w-full px-x py-3 shadow-sm shadow-gray-300'>
      <div className='h-1/3 py-7 px-12'>
        ...
        <Link to={`/map/${id}`}><button className='bg-green-500 text-white mt-5 px-5 py-3 rounded-xl font-bold shadow-sm hover:bg-green-700 flex flex-row gap-2'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
