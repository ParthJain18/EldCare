          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className='mb-5'>
                ...
                <div className="mt-7">
                 <Link to='https://buy.stripe.com/9AQ8ycdhNefx8ne9AB'> <button type='submit' className="w-full bg-primaryColor text-white text-[18px] leading-[30px] rounded-lg px-4 py-3">Proceed</button></Link>
                </div>
