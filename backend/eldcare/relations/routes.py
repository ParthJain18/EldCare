...
def get_patient(userId):
    ...
    try:
        ...
        return jsonify({"message": "An error occurred while retrieving patient.","error": e}), 402
...
def get_relative(userId):
    ...
    try:
        ...
        return jsonify({"message": "An error occurred while retrieving relative.","error": e}), 402
